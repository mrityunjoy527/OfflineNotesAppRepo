package com.example.notesmvvm.adapters
...
import com.example.notesmvvm.databinding.NoteItemLayoutBinding
import com.example.notesmvvm.fragment.NoteFragmentDirections
...
class RvNotesAdapter: ListAdapter<Note, RvNotesAdapter.NotesViewHolder>(DiffUtilCallback()) {
    ...
    inner class NotesViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        ...
        val totalItem: RelativeLayout = contentBinding.totalItem
        ...
        getItem(position).let {note ->
            holder.apply {
                ...
                totalItem.setOnClickListener {
                    val action = NoteFragmentDirections.actionNoteFragmentToSaveAndUpdateFragment().setNote(note)
